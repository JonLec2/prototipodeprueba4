...
display(){
  ...
  this.button1.style('webkit-touch-callout', 'none');
  this.button1.style('webkit-user-select', 'none');
 ...
 this.button2.style('webkit-touch-callout', 'none');
 this.button2.style('webkit-user-select', 'none');
 ...
 this.button3.style('webkit-touch-callout', 'none');
 this.button3.style('webkit-user-select', 'none');
